...
class AmongUs(commands.Cog):
    ...
    @app_commands.command(name="town-of-melody", description="Starts Town of Melody game.")
    ...
    async def _townofriz(self, interaction: discord.Interaction, murderers: app_commands.Range[int, 1, 3]):
        ...
        embed = discord.Embed(
            title=f"Town of Melody",
            description="-# Town of Melody is a murder mystery game. Catch the murderer before he kills everyone.",
            color=0xffb900
        )
...
class TORBTN(View):
    ...
    async def _start(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            title=f"Town of Melody - Game Started!",
